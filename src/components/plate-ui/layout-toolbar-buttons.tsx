...
export function RulerToggleButton() {
  ...
  // Using individual Zustand selectors isolates re-renders strictly to changes in showRuler.
...
export function PageSetupButton() {
  // ⚡ Bolt Performance Optimization:
  // Granular selection from useLayoutStore prevents unnecessary component re-renders.
...
export function LayoutToggleButton() {
  // ⚡ Bolt Performance Optimization:
  // By explicitly picking layoutMode, changes in other layout states won't trigger a render.
...
export function MultiPageToggleButton() {
  // ⚡ Bolt Performance Optimization:
  // Fetching distinct layoutMode and multiPageMode minimizes rendering cycles when unrelated state changes.
  const layoutMode = useLayoutStore((state) => state.layoutMode);
